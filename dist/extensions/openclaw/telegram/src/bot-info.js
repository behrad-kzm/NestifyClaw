...
Object.defineProperty(exports, "normalizeTelegramBotInfo", {
    enumerable: true,
    get: function() {
        return normalizeTelegramBotInfo;
    }
});
...
function normalizeTelegramBotInfo(value) {
    ...
    const bot = value;
    if (typeof bot.id !== "number" || bot.is_bot !== true || typeof bot.first_name !== "string" || typeof bot.username !== "string") {
        return undefined;
    }
    return {
        id: bot.id,
        ...
        ...typeof bot.last_name === "string" ? {
            last_name: bot.last_name
        } : {},
        ...typeof bot.language_code === "string" ? {
...
//# sourceMappingURL=bot-info.js.map