...
Object.defineProperty(exports, "stringifyTelegramRawUpdateForLog", {
    enumerable: true,
    get: function() {
        return stringifyTelegramRawUpdateForLog;
    }
});
...
const TELEGRAM_RAW_UPDATE_ALLOWED_ID_KEYS = new Set([
    "message_id",
    "update_id"
]);
...
function stringifyTelegramRawUpdateForLog(update) {
    ...
    const transform = (value, key = "", parentKey)=>{
        ...
        if (typeof value === "string") {
            return value.length > MAX_RAW_UPDATE_STRING ? `${value.slice(0, MAX_RAW_UPDATE_STRING)}...` : value;
        }
...
//# sourceMappingURL=raw-update-log.js.map