...
Object.defineProperty(exports, "formatWhatsAppInboundListeningLog", {
    enumerable: true,
    get: function() {
        return formatWhatsAppInboundListeningLog;
    }
});
function formatWhatsAppInboundListeningLog(account) {
    ...
    if (Object.keys(groups).length === 0) {
        const suffix = account.groupPolicy === "allowlist" ? "sender allowlist configured" : "no group allowlist configured";
...
//# sourceMappingURL=listener-log.js.map