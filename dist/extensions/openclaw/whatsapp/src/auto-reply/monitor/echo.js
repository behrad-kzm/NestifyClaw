...
Object.defineProperty(exports, "createEchoTracker", {
    enumerable: true,
    get: function() {
        return createEchoTracker;
    }
});
function createEchoTracker(params) {
    ...
    const rememberText = (text, opts)=>{
        ...
        if (opts.logVerboseMessage) {
            params.logVerbose?.(`Added to echo detection set (size now: ${recentlySent.size}): ${text.slice(0, 50)}...`);
        }
        trim();
    };
    return {
